"""
Django settings for testtestaasf3523_2 project.
...
ROOT_URLCONF = 'testtestaasf3523_2.urls'
...
WSGI_APPLICATION = 'testtestaasf3523_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "testtestaasf3523 Support <support@testtestaasf3523-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testtestaasf3523_2 API",
    "DESCRIPTION": "API documentation for testtestaasf3523_2 App",
    "VERSION": "v1",
}
